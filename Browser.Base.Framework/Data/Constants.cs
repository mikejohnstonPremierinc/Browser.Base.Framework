...
////using System.ComponentModel.DataAnnotations; // need to add a reference for this for it to work
...
//            "cmcd", "cmeca", "cvsce", "geagle", "isuog", "ncpalc", "nof", "riteaid", "snmmi", "wiley"};

//        public static List<string> SitesWith_SearchSort = new List<string>() { "aapa", "asnc", "cap",
//            "cmcd", "cmeca", "cvsce", "dhmc", "geagle", "isuog", "nof", "riteaid", "snmmi", "wiley"};

//        /// <summary>
//        /// Site differences: URL
//        /// </summary>
//        public static List<string> SitesWith_SearchURLIsEducation = new List<string>() { "aafprs", "aapa", "asnc", "cmcd", "cmeca",
//            "cvsce", "dhmc", "geagle", "isuog", "ncpalc", "nof", "riteaid", "snmmi", "wiley" };
//        public static List<string> SitesWith_SearchURLIsCatalog = new List<string>() { "aha" };
...
//        /// </summary>
//        public static List<string> SitesWith_PostLoginPageIsHome = new List<string>() { "uams", "onslt", "cmeca" };
...
//            [Description("Automation - Stand-alone Live Meeting")]
//            Automation_Standalone_Live_Meeting,
...
//            [Description("Automation - Assessment - 1. One Page")]
//            Automation_Assessment_1_One_Page,
