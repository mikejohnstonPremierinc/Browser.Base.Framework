...
namespace AHA.UITest
{
    ...
    [TestFixture]
    public class AHA_AssAndFeedback1 : TestBase_AHA
    {
        #region Constructors

        public AHA_AssAndFeedback1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public AHA_AssAndFeedback1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [TestFixture]
    public class AHA_AssAndFeedback2 : TestBase_AHA
    {
        #region Constructors

        public AHA_AssAndFeedback2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public AHA_AssAndFeedback2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
