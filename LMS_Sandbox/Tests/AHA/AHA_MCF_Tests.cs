...
namespace AHA.UITest
{
    ...
    [TestFixture]
    public class AHA_MCF : TestBase_AHA
    {
        #region Constructors

        public AHA_MCF(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public AHA_MCF(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
