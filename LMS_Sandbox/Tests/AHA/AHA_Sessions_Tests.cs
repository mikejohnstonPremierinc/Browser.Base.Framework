...
namespace AHA.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class AHA_Sessions_Tests_Chrome : TestBase_AHA
    {
        #region Constructors

        public AHA_Sessions_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public AHA_Sessions_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
