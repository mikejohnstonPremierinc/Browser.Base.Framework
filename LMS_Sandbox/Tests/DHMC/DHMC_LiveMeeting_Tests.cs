...
//    [TestFixture]
//    public class DHMC_LiveMeeting : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_LiveMeeting(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_LiveMeeting(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
...
//                TP.GetTranscript(Constants.SiteCodes.DHMC).Where(t => t.ActivityTitle == actTitle).ToList();
...
//            Assert.AreEqual(DateTime.Now.ToString("MM/dd/yyyy"), TranscriptForMyActivity[0].CompletionDate);
//        }
