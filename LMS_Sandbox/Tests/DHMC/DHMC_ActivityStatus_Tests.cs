...
//    [TestFixture]
//    public class DHMC_ActivityStatus_Tests : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_ActivityStatus_Tests(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_ActivityStatus_Tests(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
