...
//    /// </summary>
//    [TestFixture]
//    public class DHMC_Bundle_Tests_AllBrowsers : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_Bundle_Tests_AllBrowsers(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_Bundle_Tests_AllBrowsers(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
...
//        /// </summary>
//        [TestFixture]
//        public class DHMC_Bundle_Tests_Chrome : TestBase_DHMC
//        {
//            #region Constructors

//            public DHMC_Bundle_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//            public DHMC_Bundle_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
//                                        : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
//            { }
