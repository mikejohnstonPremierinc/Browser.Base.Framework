...
//    [TestFixture]
//    public class DHMC_MCF : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_MCF(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_MCF(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
