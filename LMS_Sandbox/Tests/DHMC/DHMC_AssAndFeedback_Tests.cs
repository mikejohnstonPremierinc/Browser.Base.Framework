...
//    [TestFixture]
//    public class DHMC_AssAndFeedback1 : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_AssAndFeedback1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_AssAndFeedback1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
...
//    [TestFixture]
//    public class DHMC_AssAndFeedback2 : TestBase_DHMC
//    {
//        #region Constructors

//        public DHMC_AssAndFeedback2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
//        public DHMC_AssAndFeedback2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
//                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
//        { }
