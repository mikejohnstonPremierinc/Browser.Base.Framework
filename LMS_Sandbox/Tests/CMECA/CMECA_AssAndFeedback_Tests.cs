...
namespace CMECA.UITest
{
    ...
    [TestFixture]
    public class CMECA_AssAndFeedback1 : TestBase_CMECA
    {
        #region Constructors

        public CMECA_AssAndFeedback1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CMECA_AssAndFeedback1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [TestFixture]
    public class CMECA_AssAndFeedback2 : TestBase_CMECA
    {
        #region Constructors

        public CMECA_AssAndFeedback2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CMECA_AssAndFeedback2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
