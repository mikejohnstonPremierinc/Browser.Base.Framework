...
namespace CMECA.UITest
{
    ...
    [TestFixture]
    public class CMECA_MCF : TestBase_CMECA
    {
        #region Constructors

        public CMECA_MCF(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CMECA_MCF(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
