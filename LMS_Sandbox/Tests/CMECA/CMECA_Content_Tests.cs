...
namespace CMECA.UITest
{
    ...
    [TestFixture]
    public class CMECA_Content : TestBase_CMECA
    {
        #region Constructors

        public CMECA_Content(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CMECA_Content(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
