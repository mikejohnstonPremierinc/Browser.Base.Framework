...
namespace CMECA.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class CMECA_Sessions_Tests_Chrome : TestBase_CMECA
    {
        #region Constructors

        public CMECA_Sessions_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CMECA_Sessions_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
