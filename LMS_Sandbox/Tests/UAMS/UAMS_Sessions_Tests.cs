...
namespace UAMS.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class UAMS_A_Sessions_Tests_Chrome : TestBase_UAMS
    {
        #region Constructors

        public UAMS_A_Sessions_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public UAMS_A_Sessions_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
