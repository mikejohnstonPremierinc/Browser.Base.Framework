...
namespace UAMS.UITest
{
    ...
    [TestFixture]
    public class UAMS_A_MCF : TestBase_UAMS
    {
        #region Constructors

        public UAMS_A_MCF(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public UAMS_A_MCF(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
