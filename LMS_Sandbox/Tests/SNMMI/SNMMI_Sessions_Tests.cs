...
namespace SNMMI.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class SNMMI_Sessions_Tests_Chrome : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_Sessions_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_Sessions_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
