...
namespace SNMMI.UITest
{
    ...
    [TestFixture]
    public class SNMMI_MCF : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_MCF(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_MCF(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
