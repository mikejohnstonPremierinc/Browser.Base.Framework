...
namespace SNMMI.UITest
{
    ...
    [TestFixture]
    public class SNMMI_AssAndFeedback1 : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_AssAndFeedback1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_AssAndFeedback1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [TestFixture]
    public class SNMMI_AssAndFeedback2 : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_AssAndFeedback2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_AssAndFeedback2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
