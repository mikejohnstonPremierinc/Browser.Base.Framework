...
namespace SNMMI.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class SNMMI_Registration_AllBrowsers : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_Registration_AllBrowsers(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_Registration_AllBrowsers(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [TestFixture]
    public class SNMMI_Registration_ChromeSet_1 : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_Registration_ChromeSet_1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_Registration_ChromeSet_1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
    ...
    [TestFixture]
    public class SNMMI_Registration_ChromeSet_2 : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_Registration_ChromeSet_2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_Registration_ChromeSet_2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
