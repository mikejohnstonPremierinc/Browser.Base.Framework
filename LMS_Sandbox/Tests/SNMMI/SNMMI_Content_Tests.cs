...
namespace SNMMI.UITest
{
    ...
    [TestFixture]
    public class SNMMI_Content : TestBase_SNMMI
    {
        #region Constructors

        public SNMMI_Content(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public SNMMI_Content(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
