...
namespace CAP.UITest
{
    ...
    [TestFixture]
    public class CAP_AssAndFeedback1 : TestBase_CAP
    {
        #region Constructors

        public CAP_AssAndFeedback1(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_AssAndFeedback1(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [TestFixture]
    public class CAP_AssAndFeedback2 : TestBase_CAP
    {
        #region Constructors

        public CAP_AssAndFeedback2(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_AssAndFeedback2(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
