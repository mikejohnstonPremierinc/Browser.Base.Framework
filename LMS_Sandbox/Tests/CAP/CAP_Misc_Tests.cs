...
namespace CAP.UITest
{
    ...
    [TestFixture]
    public class CAP_Misc : TestBase_CAP
    {
        #region Constructors

        public CAP_Misc(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_Misc(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
