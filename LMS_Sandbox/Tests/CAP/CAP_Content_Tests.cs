...
namespace CAP.UITest
{
    ...
    [TestFixture]
    public class CAP_Content : TestBase_CAP
    {
        #region Constructors

        public CAP_Content(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_Content(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
    ...
    [NonParallelizable]
    [TestFixture]
    public class CAP_Content_NonParallel : TestBase_CAP
    {
        #region Constructors

        public CAP_Content_NonParallel(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_Content_NonParallel(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
                                    : base(browserName, emulationDevice, version, platform, hubUri, extrasUri)
        { }
