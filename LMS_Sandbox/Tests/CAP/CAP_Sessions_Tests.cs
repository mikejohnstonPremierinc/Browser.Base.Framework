...
namespace CAP.UITest
{
    ...
    /// </summary>
    [TestFixture]
    public class CAP_Sessions_Tests_Chrome : TestBase_CAP
    {
        #region Constructors

        public CAP_Sessions_Tests_Chrome(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }
        public CAP_Sessions_Tests_Chrome(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
