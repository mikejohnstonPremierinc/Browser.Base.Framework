...
namespace Mainpro.UITest
{
    ...
    [TestFixture]
    public class Mainpro_RoyalCollege2Year_tests : TestBase
    {
        #region Constructors
        public Mainpro_RoyalCollege2Year_tests(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public Mainpro_RoyalCollege2Year_tests(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        [Test]
        [Description("Given a user with a 2-year cycle submits a Royal College activity with 201 credits, When the " +
            ...
            "should appear on the Activities List page at only 25 applied, Then the page should show the correct " +
            "credit amounts")]
        [Property("Status", "Complete")]
        [Author("Mike Johnston")]
        [Category("Complete")]
        public void RoyalCollege2YearCycleAdd200CreditsCertified()
        {
            ...
            /// 1. For a user in a Remedial cycle, add a Royal College activity, entering 200 credits and verify the user 
            ...
            /// 2. Validate the credit through LTS, go to the Activities List page, then verify that the CPD Activity 
            ...
            /// 3. Click Enter a CPD Activity, choose the same activity, click Continue and verify that a form appears
