...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class AllReceiptsPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public AllReceiptsPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="AllReceiptsPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement TransactionsTbl { get { return this.FindElement(Bys.AllReceiptsPage.TransactionsTbl); } }
        ...
        /// the entire page to load. <see cref="AllReceiptsPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        ...
        public override void WaitForInitialize()
        {
            ...
            // when an activity becomes corrupt for whatever reason. To fix it, you have to republish the activity. However, if this 
            // happens on the Home page or another page, then it is usually just an intermittent issue and will pass the second time
            try
            {
                this.WaitUntil(TimeSpan.FromSeconds(180), Criteria.AllReceiptsPage.PageReady);
            ...
            catch (Exception)
            {
                ...
                {
                    this.WaitUntil(TimeSpan.FromSeconds(1), Criteria.AllReceiptsPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose AllReceiptsPage", activeRequests.Count, ex); }
        }
