...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class AllReceiptsPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<AllReceiptsPage> TransactionsTblVisible = new Criteria<AllReceiptsPage>(p =>
        {
            return p.Exists(Bys.AllReceiptsPage.TransactionsTbl, ElementCriteria.IsVisible);

        }, "The Transactions table exists and is visible"); 

        public readonly ICriteria<AllReceiptsPage> SearchBtnVisible = new Criteria<AllReceiptsPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<AllReceiptsPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<AllReceiptsPage>(p =>
        {
        ...
        public readonly ICriteria<AllReceiptsPage> LoadIconNotExists = new Criteria<AllReceiptsPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="AllReceiptsPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<AllReceiptsPage> PageReady;

        public AllReceiptsPageCriteria()
        {
            PageReady = TransactionsTblVisible.AND(LoadIconNotExists);
        }
    }
}
