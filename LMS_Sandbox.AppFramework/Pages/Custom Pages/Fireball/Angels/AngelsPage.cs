...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class AngelsPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public AngelsPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/highriskpregnancyprogram"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="AngelsPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.AngelsPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys.AngelsPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys.AngelsPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys.AngelsPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys.AngelsPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys.AngelsPage.FeaturedActivitiesTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="AngelsPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.AngelsPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose AngelsPage", activeRequests.Count, ex); }
        }
