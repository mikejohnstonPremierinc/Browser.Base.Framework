...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class TraqPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public TraqPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/spineacademy"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="TraqPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement RecordedPresentationsTbl { get { return this.FindElement(Bys.TraqPage.RecordedPresentationsTbl); } }
        public IWebElement RecordedPresentationsTblFirstLnk { get { return this.FindElement(Bys.TraqPage.RecordedPresentationsTblFirstLnk); } }
        public IWebElement RegSchedTeleconfTbl { get { return this.FindElement(Bys.TraqPage.RegSchedTeleconfTbl); } }
        public IWebElement RegSchedTeleconfTblFirstLnk { get { return this.FindElement(Bys.TraqPage.RegSchedTeleconfTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys.TraqPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys.TraqPage.ComingSoonTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="TraqPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.TraqPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose TraqPage", activeRequests.Count, ex); }
        }
