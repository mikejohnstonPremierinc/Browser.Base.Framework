...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class PCGAPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public PCGAPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/pcga"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="PCGAPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.PCGAPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys.PCGAPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement ProfessionalEdu3Tbl { get { return this.FindElement(Bys.PCGAPage.ProfessionalEdu3Tbl); } }
        public IWebElement ProfessionalEdu3TblFirstLnk { get { return this.FindElement(Bys.PCGAPage.ProfessionalEdu3TblFirstLnk); } }
        public IWebElement ProfessionalEdu2Tbl { get { return this.FindElement(Bys.PCGAPage.ProfessionalEdu2Tbl); } }
        public IWebElement ProfessionalEdu2TblFirstLnk { get { return this.FindElement(Bys.PCGAPage.ProfessionalEdu2TblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="PCGAPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.PCGAPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose PCGAPage", activeRequests.Count, ex); }
        }
