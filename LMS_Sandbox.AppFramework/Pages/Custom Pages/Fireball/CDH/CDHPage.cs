...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class CDHPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public CDHPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/IDHI"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="CDHPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.CDHPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys.CDHPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement AdditionalResourcesTbl { get { return this.FindElement(Bys.CDHPage.AdditionalResourcesTbl); } }
        public IWebElement AdditionalResourcesTblFirstLnk { get { return this.FindElement(Bys.CDHPage.AdditionalResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys.CDHPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys.CDHPage.ComingSoonTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="CDHPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.CDHPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose CDHPage", activeRequests.Count, ex); }
        }
