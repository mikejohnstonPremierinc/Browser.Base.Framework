...
namespace LMS.AppFramework
{
    ...
    public class CDHPageCriteria
    {
        ...
        /// </summary>
        public readonly ICriteria<CDHPage> ProfessionalEduTblFirstLnkVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Edu table exists and is visible");

        public readonly ICriteria<CDHPage> AdditionalResourcesTblFirstLnkVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.AdditionalResourcesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Additional Resources table exists and is visible");

        public readonly ICriteria<CDHPage> ComingSoonTblFirstLnkVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.ComingSoonTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Coming Soon table exists and is visible");


        public readonly ICriteria<CDHPage> ProfessionalEduTblViewAllBtnVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.ProfessionalEduTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Professional Edu table exists and is visible");

        public readonly ICriteria<CDHPage> AdditionalResourcesTblViewAllBtnVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.AdditionalResourcesTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Additional Resources table exists and is visible");

        public readonly ICriteria<CDHPage> ComingSoonTblViewAllBtnVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.CDHPage.ComingSoonTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Coming Soon table exists and is visible");


        public readonly ICriteria<CDHPage> SearchBtnVisible = new Criteria<CDHPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<CDHPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<CDHPage>(p =>
        {
        ...
        public readonly ICriteria<CDHPage> LoadIconNotExists = new Criteria<CDHPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="CDHPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<CDHPage> PageReady;

        public CDHPageCriteria()
        {
            PageReady = AdditionalResourcesTblViewAllBtnVisible.AND(ComingSoonTblViewAllBtnVisible).
