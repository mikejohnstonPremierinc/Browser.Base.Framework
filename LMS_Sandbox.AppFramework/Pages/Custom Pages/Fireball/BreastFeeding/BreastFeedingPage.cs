...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class BreastFeedingPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public BreastFeedingPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/breastfeeding"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="BreastFeedingPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement BreastFeeingCurricTbl { get { return this.FindElement(Bys.BreastFeedingPage.BreastFeeingCurricTbl); } }
        public IWebElement BreastFeeingCurricTblFirstLnk { get { return this.FindElement(Bys.BreastFeedingPage.BreastFeeingCurricTblFirstLnk); } }
        public IWebElement BundledActivitiesTbl { get { return this.FindElement(Bys.BreastFeedingPage.BundledActivitiesTbl); } }
        public IWebElement BundledActivitiesTblFirstLnk { get { return this.FindElement(Bys.BreastFeedingPage.BundledActivitiesTblFirstLnk); } }
        public IWebElement BundledProgramsTbl { get { return this.FindElement(Bys.BreastFeedingPage.BundledProgramsTbl); } }
        public IWebElement BundledProgramsTblFirstLnk { get { return this.FindElement(Bys.BreastFeedingPage.BundledProgramsTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys.BreastFeedingPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys.BreastFeedingPage.FeaturedActivitiesTblFirstLnk); } }
        public IWebElement MainHdr { get { return this.FindElement(Bys.BreastFeedingPage.MainHdr); } }
        ...
        /// the entire page to load. <see cref="BreastFeedingPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.BreastFeedingPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose BreastFeedingPage", activeRequests.Count, ex); }
        }
