...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class GenericCustomPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public GenericCustomPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/" + GetSpecificCustomPageURL(); } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="GenericCustomPageBys"/>. That class is where we locate all elements
        ...
        /// the entire page to load. <see cref="GenericCustomPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.GenericCustomPage.PageReady);
            Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(90));
        }

        private string GetSpecificCustomPageURL()
        {
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose GenericCustomPage", activeRequests.Count, ex); }
        }
