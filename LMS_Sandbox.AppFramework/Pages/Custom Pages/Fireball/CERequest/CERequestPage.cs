...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class CERequestPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public CERequestPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/requestforservice"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="CERequestPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ClickHereLnk { get { return this.FindElement(Bys.CERequestPage.VideographyLnk); } }
        public IWebElement CERequestsHeaderLbl { get { return this.FindElement(Bys.CERequestPage.CERequestsHeaderLbl); } }
        ...
        /// the entire page to load. <see cref="CERequestPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.CERequestPage.PageReady);
        }
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose CERequestPage", activeRequests.Count, ex); }
        }
