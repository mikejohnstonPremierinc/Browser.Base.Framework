...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class SCTRCPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<SCTRCPage> ProfessionalEducationTblFirstLnkVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Education table exists and is visible");

        public readonly ICriteria<SCTRCPage> MyRecentActivitiesTblFirstLnkVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.MyRecentActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<SCTRCPage> FeaturedActivitiesTblFirstLnkVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.FeaturedActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Featured Activities table exists and is visible");


        public readonly ICriteria<SCTRCPage> FeaturedActivitiesTblViewAllBtnVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.FeaturedActivitiesTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Professional Education table exists and is visible");

        public readonly ICriteria<SCTRCPage> MyRecentActivitiesTblViewAllBtnVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.MyRecentActivitiesTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<SCTRCPage> ProfessionalEduTblViewAllBtnVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.SCTRCPage.ProfessionalEduTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Featured Activities table exists and is visible");

        public readonly ICriteria<SCTRCPage> SearchBtnVisible = new Criteria<SCTRCPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<SCTRCPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<SCTRCPage>(p =>
        {
        ...
        public readonly ICriteria<SCTRCPage> LoadIconNotExists = new Criteria<SCTRCPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="SCTRCPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<SCTRCPage> PageReady;

        public SCTRCPageCriteria()
        {
