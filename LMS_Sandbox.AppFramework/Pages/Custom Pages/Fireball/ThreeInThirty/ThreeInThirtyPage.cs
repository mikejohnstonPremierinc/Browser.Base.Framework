...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class ThreeInThirtyPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public ThreeInThirtyPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/patienteducation"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="ThreeInThirtyPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ComingSoon1Tbl { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon1Tbl); } }
        public IWebElement ComingSoon1TblFirstLnk { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon1TblFirstLnk); } }
        public IWebElement ComingSoon2Tbl { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon2Tbl); } }
        public IWebElement ComingSoon2TblFirstLnk { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon2TblFirstLnk); } }
        public IWebElement ComingSoon3Tbl { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon3Tbl); } }
        public IWebElement ComingSoon3TblFirstLnk { get { return this.FindElement(Bys.ThreeInThirtyPage.ComingSoon3TblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="ThreeInThirtyPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.ThreeInThirtyPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose ThreeInThirtyPage", activeRequests.Count, ex); }
        }
