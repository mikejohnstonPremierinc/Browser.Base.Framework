...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class ARSavesPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<ARSavesPage> ProfessionalEducationTblFirstLnkVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Education table exists and is visible");

        public readonly ICriteria<ARSavesPage> MyRecentActivitiesTblFirstLnkVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.MyRecentActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<ARSavesPage> FeaturedActivitiesTblFirstLnkVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.FeaturedActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Featured Activities table exists and is visible");


        public readonly ICriteria<ARSavesPage> FeaturedActivitiesTblViewAllBtnVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.FeaturedActivitiesTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Professional Education table exists and is visible");

        public readonly ICriteria<ARSavesPage> MyRecentActivitiesTblViewAllBtnVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.MyRecentActivitiesTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<ARSavesPage> ProfessionalEduTblViewAllBtnVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.ARSavesPage.ProfessionalEduTblViewAllBtn, ElementCriteria.IsVisible);

        }, "The View All link from the Featured Activities table exists and is visible");



        public readonly ICriteria<ARSavesPage> SearchBtnVisible = new Criteria<ARSavesPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<ARSavesPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<ARSavesPage>(p =>
        {
        ...
        public readonly ICriteria<ARSavesPage> LoadIconNotExists = new Criteria<ARSavesPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="ARSavesPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<ARSavesPage> PageReady;

        public ARSavesPageCriteria()
        {
