...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class TriumphPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public TriumphPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/triumph"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="TriumphPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.TriumphPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys.TriumphPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys.TriumphPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys.TriumphPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys.TriumphPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys.TriumphPage.FeaturedActivitiesTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="TriumphPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.TriumphPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose TriumphPage", activeRequests.Count, ex); }
        }
