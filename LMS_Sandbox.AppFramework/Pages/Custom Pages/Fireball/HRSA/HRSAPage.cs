...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class HRSAPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public HRSAPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/hrsa"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="HRSAPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement GeriatricKnowledgeTbl { get { return this.FindElement(Bys.HRSAPage.GeriatricKnowledgeTbl); } }
        public IWebElement GeriatricKnowledgeTblFirstLnk { get { return this.FindElement(Bys.HRSAPage.GeriatricKnowledgeTblFirstLnk); } }
        public IWebElement InterprofessionalEducationTbl { get { return this.FindElement(Bys.HRSAPage.InterprofessionalEducationTbl); } }
        public IWebElement InterprofessionalEducationTblFirstLnk { get { return this.FindElement(Bys.HRSAPage.InterprofessionalEducationTblFirstLnk); } }
        public IWebElement EducationCompetenciesTbl { get { return this.FindElement(Bys.HRSAPage.EducationCompetenciesTbl); } }
        public IWebElement EducationCompetenciesTblFirstLnk { get { return this.FindElement(Bys.HRSAPage.EducationCompetenciesTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="HRSAPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.HRSAPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose HRSAPage", activeRequests.Count, ex); }
        }
