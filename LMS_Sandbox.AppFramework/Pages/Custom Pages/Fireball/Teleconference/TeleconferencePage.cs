...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class TeleconferencePage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public TeleconferencePage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/teleconference"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="TeleconferencePageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement CalendarTbl { get { return this.FindElement(Bys.TeleconferencePage.CalendarTbl); } }
        public IWebElement CalendarTblFirstRow { get { return this.FindElement(Bys.TeleconferencePage.CalendarTblFirstRow); } }
        ...
        /// the entire page to load. <see cref="TeleconferencePageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.TeleconferencePage.PageReady);
        }
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose TeleconferencePage", activeRequests.Count, ex); }
        }
