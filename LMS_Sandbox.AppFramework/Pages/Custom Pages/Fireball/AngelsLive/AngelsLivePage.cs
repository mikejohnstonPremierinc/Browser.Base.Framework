...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class AngelsLivePage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public AngelsLivePage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/digitalhealth"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="AngelsLivePageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement SpecialEventsTbl { get { return this.FindElement(Bys.AngelsLivePage.SpecialEventsTbl); } }
        public IWebElement FetalHeartMonitoringTblFirstLnk { get { return this.FindElement(Bys.AngelsLivePage.FetalHeartMonitoringTblFirstLnk); } }
        public IWebElement FetalHeartMonitoringTbl { get { return this.FindElement(Bys.AngelsLivePage.FetalHeartMonitoringTbl); } }
        public IWebElement OBEmergenciesTblFirstLnk { get { return this.FindElement(Bys.AngelsLivePage.OBEmergenciesTblFirstLnk); } }
        public IWebElement OBEmergenciesTbl { get { return this.FindElement(Bys.AngelsLivePage.OBEmergenciesTbl); } }
        public IWebElement SpecialEventsTblFirstLnk { get { return this.FindElement(Bys.AngelsLivePage.SpecialEventsTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="AngelsLivePageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.AngelsLivePage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose AngelsLivePage", activeRequests.Count, ex); }
        }
