...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class AdultSickleCellPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public AdultSickleCellPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/adultSickleCell"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="AdultSickleCellPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.AdultSickleCellPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys.AdultSickleCellPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement AdditionalResourcesTbl { get { return this.FindElement(Bys.AdultSickleCellPage.AdditionalResourcesTbl); } }
        public IWebElement AdditionalResourcesTblFirstLnk { get { return this.FindElement(Bys.AdultSickleCellPage.AdditionalResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys.AdultSickleCellPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys.AdultSickleCellPage.ComingSoonTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="AdultSickleCellPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.AdultSickleCellPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose AdultSickleCellPage", activeRequests.Count, ex); }
        }
