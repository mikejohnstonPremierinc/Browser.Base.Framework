...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class ARImpactPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public ARImpactPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/arimpact"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="ARImpactPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.ARImpactPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys.ARImpactPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement ResourcesTbl { get { return this.FindElement(Bys.ARImpactPage.ResourcesTbl); } }
        public IWebElement ResourcesTblFirstLnk { get { return this.FindElement(Bys.ARImpactPage.ResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys.ARImpactPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys.ARImpactPage.ComingSoonTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="ARImpactPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.ARImpactPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose ARImpactPage", activeRequests.Count, ex); }
        }
