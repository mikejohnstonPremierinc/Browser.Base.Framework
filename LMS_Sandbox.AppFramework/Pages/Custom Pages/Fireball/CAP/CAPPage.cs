...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class CAPPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public CAPPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "lms/cap"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="CAPPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement UpcomingCapPresTbl { get { return this.FindElement(Bys.CAPPage.UpcomingCapPresTbl); } }
        public IWebElement UpcomingCapPresTblFirstLnk { get { return this.FindElement(Bys.CAPPage.UpcomingCapPresTblFirstLnk); } }
        public IWebElement RegSchedTeleconfTbl { get { return this.FindElement(Bys.CAPPage.RegSchedTeleconfTbl); } }
        public IWebElement RegSchedTeleconfTblFirstLnk { get { return this.FindElement(Bys.CAPPage.RegSchedTeleconfTblFirstLnk); } }
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys.CAPPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys.CAPPage.ProfessionalEduTblFirstLnk); } }
        ...
        /// the entire page to load. <see cref="CAPPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.CAPPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose CAPPage", activeRequests.Count, ex); }
        }
