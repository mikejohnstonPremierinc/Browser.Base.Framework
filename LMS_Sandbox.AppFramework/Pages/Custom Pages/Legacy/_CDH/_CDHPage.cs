...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _CDHPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _CDHPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "IDHI.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_CDHPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._CDHPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys._CDHPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement AdditionalResourcesTbl { get { return this.FindElement(Bys._CDHPage.AdditionalResourcesTbl); } }
        public IWebElement AdditionalResourcesTblFirstLnk { get { return this.FindElement(Bys._CDHPage.AdditionalResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys._CDHPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys._CDHPage.ComingSoonTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._CDHPage.ProfessionalEduTblHdrLnks); } }
        public IList<IWebElement> AdditionalResourcesTblHdrLnks { get { return this.FindElements(Bys._CDHPage.AdditionalResourcesTblHdrLnks); } }
        public IList<IWebElement> ComingSoonTblHdrLnks { get { return this.FindElements(Bys._CDHPage.ComingSoonTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_CDHPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._CDHPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _CDHPage", activeRequests.Count, ex); }
        }
