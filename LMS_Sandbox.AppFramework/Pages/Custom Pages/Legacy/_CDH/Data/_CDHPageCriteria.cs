...
namespace LMS.AppFramework
{
    ...
    public class _CDHPageCriteria
    {
        ...
        /// </summary>
        public readonly ICriteria<_CDHPage> ProfessionalEduTblFirstLnkVisible = new Criteria<_CDHPage>(p =>
        {
            return p.Exists(Bys._CDHPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Edu table exists and is visible");

        public readonly ICriteria<_CDHPage> AdditionalResourcesTblFirstLnkVisible = new Criteria<_CDHPage>(p =>
        {
            return p.Exists(Bys._CDHPage.AdditionalResourcesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Additional Resources table exists and is visible");

        public readonly ICriteria<_CDHPage> ComingSoonTblFirstLnkVisible = new Criteria<_CDHPage>(p =>
        {
            return p.Exists(Bys._CDHPage.ComingSoonTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Coming Soon table exists and is visible");

        public readonly ICriteria<_CDHPage> SearchBtnVisible = new Criteria<_CDHPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_CDHPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_CDHPage>(p =>
        {
        ...
        public readonly ICriteria<_CDHPage> LoadIconNotExists = new Criteria<_CDHPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_CDHPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_CDHPage> PageReady;

        public _CDHPageCriteria()
        {
