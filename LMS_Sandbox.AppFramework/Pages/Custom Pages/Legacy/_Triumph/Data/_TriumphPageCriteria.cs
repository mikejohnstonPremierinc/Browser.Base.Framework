...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _TriumphPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_TriumphPage> ProfessionalEducationTblFirstLnkVisible = new Criteria<_TriumphPage>(p =>
        {
            return p.Exists(Bys._TriumphPage.ProfessionalEducationTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Education table exists and is visible");

        public readonly ICriteria<_TriumphPage> MyRecentActivitiesTblFirstLnkVisible = new Criteria<_TriumphPage>(p =>
        {
            return p.Exists(Bys._TriumphPage.MyRecentActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<_TriumphPage> FeaturedActivitiesTblFirstLnkVisible = new Criteria<_TriumphPage>(p =>
        {
            return p.Exists(Bys._TriumphPage.FeaturedActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Featured Activities table exists and is visible");

        public readonly ICriteria<_TriumphPage> SearchBtnVisible = new Criteria<_TriumphPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_TriumphPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_TriumphPage>(p =>
        {
        ...
        public readonly ICriteria<_TriumphPage> LoadIconNotExists = new Criteria<_TriumphPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_TriumphPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_TriumphPage> PageReady;

        public _TriumphPageCriteria()
        {
