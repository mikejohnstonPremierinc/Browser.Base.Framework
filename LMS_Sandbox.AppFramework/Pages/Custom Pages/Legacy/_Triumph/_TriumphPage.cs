...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _TriumphPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _TriumphPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "triumph.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_TriumphPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._TriumphPage.ProfessionalEducationTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys._TriumphPage.ProfessionalEducationTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys._TriumphPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys._TriumphPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys._TriumphPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys._TriumphPage.FeaturedActivitiesTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._TriumphPage.ProfessionalEducationTblHdrLnks); } }
        public IList<IWebElement> MyRecentActivitiesTblHdrLnks { get { return this.FindElements(Bys._TriumphPage.MyRecentActivitiesTblHdrLnks); } }
        public IList<IWebElement> FeaturedActivitiesTblHdrLnks { get { return this.FindElements(Bys._TriumphPage.FeaturedActivitiesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_TriumphPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._TriumphPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _TriumphPage", activeRequests.Count, ex); }
        }
