...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _PRIPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _PRIPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "pri.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_PRIPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._PRIPage.ProfessionalEducationTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys._PRIPage.ProfessionalEducationTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys._PRIPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys._PRIPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys._PRIPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys._PRIPage.FeaturedActivitiesTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._PRIPage.ProfessionalEducationTblHdrLnks); } }
        public IList<IWebElement> MyRecentActivitiesTblHdrLnks { get { return this.FindElements(Bys._PRIPage.MyRecentActivitiesTblHdrLnks); } }
        public IList<IWebElement> FeaturedActivitiesTblHdrLnks { get { return this.FindElements(Bys._PRIPage.FeaturedActivitiesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_PRIPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._PRIPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _PRIPage", activeRequests.Count, ex); }
        }
