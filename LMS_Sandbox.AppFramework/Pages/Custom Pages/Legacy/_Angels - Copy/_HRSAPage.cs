...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _HRSAPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _HRSAPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "hrsa.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_HRSAPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement GeriatricKnowledgeTbl { get { return this.FindElement(Bys._HRSAPage.GeriatricKnowledgeTbl); } }
        public IWebElement GeriatricKnowledgeTblFirstLnk { get { return this.FindElement(Bys._HRSAPage.GeriatricKnowledgeTblFirstLnk); } }
        public IWebElement InterprofessionalEducationTbl { get { return this.FindElement(Bys._HRSAPage.InterprofessionalEducationTbl); } }
        public IWebElement InterprofessionalEducationTblFirstLnk { get { return this.FindElement(Bys._HRSAPage.InterprofessionalEducationTblFirstLnk); } }
        public IWebElement EducationCompetenciesTbl { get { return this.FindElement(Bys._HRSAPage.EducationCompetenciesTbl); } }
        public IWebElement EducationCompetenciesTblFirstLnk { get { return this.FindElement(Bys._HRSAPage.EducationCompetenciesTblFirstLnk); } }
        //public IWebElement MainHdr { get { return this.FindElement(Bys._HRSAPage.MainHdr); } }
        public IList<IWebElement> GeriatricKnowledgeTblHdrLnks { get { return this.FindElements(Bys._HRSAPage.GeriatricKnowledgeTblHdrLnks); } }
        public IList<IWebElement> InterprofessionalEducationTblHdrLnks { get { return this.FindElements(Bys._HRSAPage.InterprofessionalEducationTblHdrLnks); } }
        public IList<IWebElement> EducationCompetenciesTblHdrLnks { get { return this.FindElements(Bys._HRSAPage.EducationCompetenciesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_HRSAPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._HRSAPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _HRSAPage", activeRequests.Count, ex); }
        }
