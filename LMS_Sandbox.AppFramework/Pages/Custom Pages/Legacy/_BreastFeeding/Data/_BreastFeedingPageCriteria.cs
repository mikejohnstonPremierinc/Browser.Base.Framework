...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _BreastFeedingPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_BreastFeedingPage> BreastFeeingCurricTblFirstLnkVisible = new Criteria<_BreastFeedingPage>(p =>
        {
            return p.Exists(Bys._BreastFeedingPage.BreastFeeingCurricTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Breast Feeding Curriculum table exists and is visible");

        public readonly ICriteria<_BreastFeedingPage> BundledActivitiesTblFirstLnkVisible = new Criteria<_BreastFeedingPage>(p =>
        {
            return p.Exists(Bys._BreastFeedingPage.BundledActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Bundled Activities table exists and is visible");

        public readonly ICriteria<_BreastFeedingPage> BundledProgramsTblFirstLnkVisible = new Criteria<_BreastFeedingPage>(p =>
        {
            return p.Exists(Bys._BreastFeedingPage.BundledProgramsTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Bundled Programs table exists and is visible");

        public readonly ICriteria<_BreastFeedingPage> FeaturedActivitiesTblFirstLnkVisible = new Criteria<_BreastFeedingPage>(p =>
        {
            return p.Exists(Bys._BreastFeedingPage.FeaturedActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Featured Activities table exists and is visible");


        public readonly ICriteria<_BreastFeedingPage> SearchBtnVisible = new Criteria<_BreastFeedingPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_BreastFeedingPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_BreastFeedingPage>(p =>
        {
        ...
        public readonly ICriteria<_BreastFeedingPage> LoadIconNotExists = new Criteria<_BreastFeedingPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_BreastFeedingPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_BreastFeedingPage> PageReady;

        public _BreastFeedingPageCriteria()
        {
            PageReady = BreastFeeingCurricTblFirstLnkVisible.AND(BreastFeeingCurricTblFirstLnkVisible).AND(LoadIconNotExists);
        }
    }
}
