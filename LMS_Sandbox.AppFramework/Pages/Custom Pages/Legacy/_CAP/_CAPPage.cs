...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _CAPPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _CAPPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "cap.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_CAPPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement UpcomingCapPresTbl { get { return this.FindElement(Bys._CAPPage.UpcomingCapPresTbl); } }
        public IWebElement UpcomingCapPresTblFirstLnk { get { return this.FindElement(Bys._CAPPage.UpcomingCapPresTblFirstLnk); } }
        public IWebElement RegSchedTeleconfTbl { get { return this.FindElement(Bys._CAPPage.RegSchedTeleconfTbl); } }
        public IWebElement RegSchedTeleconfTblFirstLnk { get { return this.FindElement(Bys._CAPPage.RegSchedTeleconfTblFirstLnk); } }
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._CAPPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys._CAPPage.ProfessionalEduTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._CAPPage.ProfessionalEduTblHdrLnks); } }
        public IList<IWebElement> RegSchedTeleconfTblHdrLnks { get { return this.FindElements(Bys._CAPPage.RegSchedTeleconfTblHdrLnks); } }
        public IList<IWebElement> UpcomingCapPresTblHdrLnks { get { return this.FindElements(Bys._CAPPage.UpcomingCapPresTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_CAPPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._CAPPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _CAPPage", activeRequests.Count, ex); }
        }
