...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AngelsLivePage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _AngelsLivePage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "digitalhealth.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_AngelsLivePageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement SpecialEventsTblFirstLnk { get { return this.FindElement(Bys._AngelsLivePage.SpecialEventsTblFirstLnk); } }
        public IWebElement SpecialEventsTbl { get { return this.FindElement(Bys._AngelsLivePage.SpecialEventsTbl); } }
        public IWebElement FetalHeartMonitoringTblFirstLnk { get { return this.FindElement(Bys._AngelsLivePage.FetalHeartMonitoringTblFirstLnk); } }
        public IWebElement FetalHeartMonitoringTbl { get { return this.FindElement(Bys._AngelsLivePage.FetalHeartMonitoringTbl); } }
        public IWebElement OBEmergenciesTblFirstLnk { get { return this.FindElement(Bys._AngelsLivePage.OBEmergenciesTblFirstLnk); } }
        public IWebElement OBEmergenciesTbl { get { return this.FindElement(Bys._AngelsLivePage.OBEmergenciesTbl); } }
        public IList<IWebElement> SpecialEventsTblHdrLnks { get { return this.FindElements(Bys._AngelsLivePage.SpecialEventsTblHdrLnks); } }
        public IList<IWebElement> FetalHeartMonitoringTblHdrLnks { get { return this.FindElements(Bys._AngelsLivePage.FetalHeartMonitoringTblHdrLnks); } }
        public IList<IWebElement> OBEmergenciesTblHdrLnks { get { return this.FindElements(Bys._AngelsLivePage.OBEmergenciesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_AngelsLivePageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._AngelsLivePage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _AngelsLivePage", activeRequests.Count, ex); }
        }
