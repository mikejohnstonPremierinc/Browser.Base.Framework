...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AngelsLivePageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_AngelsLivePage> FetalHeartMonitoringTblFirstLnkVisible = new Criteria<_AngelsLivePage>(p =>
        {
            return p.Exists(Bys._AngelsLivePage.FetalHeartMonitoringTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Fetal Heart Monitoring table exists and is visible");

        public readonly ICriteria<_AngelsLivePage> OBTblFirstLnkVisible = new Criteria<_AngelsLivePage>(p =>
        {
            return p.Exists(Bys._AngelsLivePage.OBEmergenciesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the OB table exists and is visible");

        public readonly ICriteria<_AngelsLivePage> SpecialEventsTblFirstLnkVisible = new Criteria<_AngelsLivePage>(p =>
        {
            return p.Exists(Bys._AngelsLivePage.SpecialEventsTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Special Events table exists and is visible");

        public readonly ICriteria<_AngelsLivePage> SearchBtnVisible = new Criteria<_AngelsLivePage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_AngelsLivePage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_AngelsLivePage>(p =>
        {
        ...
        public readonly ICriteria<_AngelsLivePage> LoadIconNotExists = new Criteria<_AngelsLivePage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_AngelsLivePage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_AngelsLivePage> PageReady;

        public _AngelsLivePageCriteria()
        {
            PageReady = FetalHeartMonitoringTblFirstLnkVisible.
                AND(OBTblFirstLnkVisible).
                AND(SpecialEventsTblFirstLnkVisible)
