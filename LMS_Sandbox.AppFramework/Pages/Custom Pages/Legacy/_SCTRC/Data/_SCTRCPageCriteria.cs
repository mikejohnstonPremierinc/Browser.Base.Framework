...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _SCTRCPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_SCTRCPage> ProfessionalEducationTblFirstLnkVisible = new Criteria<_SCTRCPage>(p =>
        {
            return p.Exists(Bys._SCTRCPage.ProfessionalEducationTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Education table exists and is visible");

        public readonly ICriteria<_SCTRCPage> MyRecentActivitiesTblFirstLnkVisible = new Criteria<_SCTRCPage>(p =>
        {
            return p.Exists(Bys._SCTRCPage.MyRecentActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the My Recent Activities table exists and is visible");

        public readonly ICriteria<_SCTRCPage> FeaturedActivitiesTblFirstLnkVisible = new Criteria<_SCTRCPage>(p =>
        {
            return p.Exists(Bys._SCTRCPage.FeaturedActivitiesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Featured Activities table exists and is visible");

        public readonly ICriteria<_SCTRCPage> SearchBtnVisible = new Criteria<_SCTRCPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_SCTRCPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_SCTRCPage>(p =>
        {
        ...
        public readonly ICriteria<_SCTRCPage> LoadIconNotExists = new Criteria<_SCTRCPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_SCTRCPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_SCTRCPage> PageReady;

        public _SCTRCPageCriteria()
        {
