...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _ARImpactPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_ARImpactPage> ProfessionalEduTblFirstLnkVisible = new Criteria<_ARImpactPage>(p =>
        {
            return p.Exists(Bys._ARImpactPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Edu table exists and is visible");

        public readonly ICriteria<_ARImpactPage> ResourcesTblFirstLnkVisible = new Criteria<_ARImpactPage>(p =>
        {
            return p.Exists(Bys._ARImpactPage.ResourcesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Resources table exists and is visible");

        public readonly ICriteria<_ARImpactPage> ComingSoonTblFirstLnkVisible = new Criteria<_ARImpactPage>(p =>
        {
            return p.Exists(Bys._ARImpactPage.ComingSoonTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Resources table exists and is visible");

        public readonly ICriteria<_ARImpactPage> SearchBtnVisible = new Criteria<_ARImpactPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_ARImpactPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_ARImpactPage>(p =>
        {
        ...
        public readonly ICriteria<_ARImpactPage> LoadIconNotExists = new Criteria<_ARImpactPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_ARImpactPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_ARImpactPage> PageReady;

        public _ARImpactPageCriteria()
        {
            PageReady = ProfessionalEduTblFirstLnkVisible.AND(ResourcesTblFirstLnkVisible).
