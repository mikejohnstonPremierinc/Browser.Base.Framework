...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _ARImpactPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _ARImpactPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "ar-impact.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_ARImpactPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._ARImpactPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys._ARImpactPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement ResourcesTbl { get { return this.FindElement(Bys._ARImpactPage.ResourcesTbl); } }
        public IWebElement ResourcesTblFirstLnk { get { return this.FindElement(Bys._ARImpactPage.ResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys._ARImpactPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys._ARImpactPage.ComingSoonTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._ARImpactPage.ProfessionalEduTblHdrLnks); } }
        public IList<IWebElement> ResourcesTblHdrLnks { get { return this.FindElements(Bys._ARImpactPage.ResourcesTblHdrLnks); } }
        public IList<IWebElement> ComingSoonTblHdrLnks { get { return this.FindElements(Bys._ARImpactPage.ComingSoonTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_ARImpactPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._ARImpactPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _ARImpactPage", activeRequests.Count, ex); }
        }
