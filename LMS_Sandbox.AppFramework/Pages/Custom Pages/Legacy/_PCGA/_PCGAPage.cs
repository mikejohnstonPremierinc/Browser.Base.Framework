...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _PCGAPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _PCGAPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "pcga.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_PCGAPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._PCGAPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys._PCGAPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement ProfessionalEducation3Tbl { get { return this.FindElement(Bys._PCGAPage.ProfessionalEducation3Tbl); } }
        public IWebElement ProfessionalEducation3TblFirstLnk { get { return this.FindElement(Bys._PCGAPage.ProfessionalEducation3TblFirstLnk); } }
        public IWebElement ProfessionalEducation2Tbl { get { return this.FindElement(Bys._PCGAPage.ProfessionalEducation2Tbl); } }
        public IWebElement ProfessionalEducation2TblFirstLnk { get { return this.FindElement(Bys._PCGAPage.ProfessionalEducation2TblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._PCGAPage.ProfessionalEduTblHdrLnks); } }
        public IList<IWebElement> ProfessionalEducation2TblHdrLnks { get { return this.FindElements(Bys._PCGAPage.ProfessionalEducation2TblHdrLnks); } }
        public IList<IWebElement> ProfessionalEducation3TblHdrLnks { get { return this.FindElements(Bys._PCGAPage.ProfessionalEducation3TblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_PCGAPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._PCGAPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _PCGAPage", activeRequests.Count, ex); }
        }
