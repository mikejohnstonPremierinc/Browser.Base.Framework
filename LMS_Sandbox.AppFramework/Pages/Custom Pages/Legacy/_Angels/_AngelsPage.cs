...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AngelsPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _AngelsPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "highriskpregnancyprogram.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_AngelsPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._AngelsPage.ProfessionalEducationTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys._AngelsPage.ProfessionalEducationTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys._AngelsPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys._AngelsPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys._AngelsPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys._AngelsPage.FeaturedActivitiesTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._AngelsPage.ProfessionalEducationTblHdrLnks); } }
        public IList<IWebElement> MyRecentActivitiesTblHdrLnks { get { return this.FindElements(Bys._AngelsPage.MyRecentActivitiesTblHdrLnks); } }
        public IList<IWebElement> FeaturedActivitiesTblHdrLnks { get { return this.FindElements(Bys._AngelsPage.FeaturedActivitiesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_AngelsPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._AngelsPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _AngelsPage", activeRequests.Count, ex); }
        }
