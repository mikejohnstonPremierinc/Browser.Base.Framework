...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AdultSickleCellPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_AdultSickleCellPage> ProfessionalEduTblFirstLnkVisible = new Criteria<_AdultSickleCellPage>(p =>
        {
            return p.Exists(Bys._AdultSickleCellPage.ProfessionalEduTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Professional Edu table exists and is visible");

        public readonly ICriteria<_AdultSickleCellPage> AdditionalResourcesTblFirstLnkVisible = new Criteria<_AdultSickleCellPage>(p =>
        {
            return p.Exists(Bys._AdultSickleCellPage.AdditionalResourcesTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Additional Resources table exists and is visible");

        public readonly ICriteria<_AdultSickleCellPage> ComingSoonTblFirstLnkVisible = new Criteria<_AdultSickleCellPage>(p =>
        {
            return p.Exists(Bys._AdultSickleCellPage.ComingSoonTblFirstLnk, ElementCriteria.IsVisible);

        }, "The first link from the Coming Soon table exists and is visible");

        public readonly ICriteria<_AdultSickleCellPage> SearchBtnVisible = new Criteria<_AdultSickleCellPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_AdultSickleCellPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_AdultSickleCellPage>(p =>
        {
        ...
        public readonly ICriteria<_AdultSickleCellPage> LoadIconNotExists = new Criteria<_AdultSickleCellPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_AdultSickleCellPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_AdultSickleCellPage> PageReady;

        public _AdultSickleCellPageCriteria()
        {
            PageReady = AdditionalResourcesTblFirstLnkVisible.AND(ProfessionalEduTblFirstLnkVisible).
