...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AdultSickleCellPageBys
    {
        ...
        public readonly By AdditionalResourcesTblHdrLnks = By.XPath("(//span[contains(@id, 'UAMS')])[3]/../descendant::span//a[@href]");
        ...
        public readonly By AdditionalResourcesTbl = By.XPath("//div[@class='ActList1']");
        public readonly By AdditionalResourcesTblFirstLnk = By.XPath("//div[@class='ActList1']//td/a | //div[@class='ActList1']//div[contains(text(), 'No custom list of activities') or contains(text(), 'No recent activities')]");
