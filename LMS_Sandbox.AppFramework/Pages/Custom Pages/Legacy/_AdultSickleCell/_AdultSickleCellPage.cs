...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _AdultSickleCellPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _AdultSickleCellPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "sicklecellhcp.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_AdultSickleCellPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._AdultSickleCellPage.ProfessionalEduTbl); } }
        public IWebElement ProfessionalEduTblFirstLnk { get { return this.FindElement(Bys._AdultSickleCellPage.ProfessionalEduTblFirstLnk); } }
        public IWebElement AdditionalResourcesTbl { get { return this.FindElement(Bys._AdultSickleCellPage.AdditionalResourcesTbl); } }
        public IWebElement AdditionalResourcesTblFirstLnk { get { return this.FindElement(Bys._AdultSickleCellPage.AdditionalResourcesTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys._AdultSickleCellPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys._AdultSickleCellPage.ComingSoonTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._AdultSickleCellPage.ProfessionalEduTblHdrLnks); } }
        public IList<IWebElement> AdditionalResourcesTblHdrLnks { get { return this.FindElements(Bys._AdultSickleCellPage.AdditionalResourcesTblHdrLnks); } }
        public IList<IWebElement> ComingSoonTblHdrLnks { get { return this.FindElements(Bys._AdultSickleCellPage.ComingSoonTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_AdultSickleCellPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._AdultSickleCellPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _AdultSickleCellPage", activeRequests.Count, ex); }
        }
