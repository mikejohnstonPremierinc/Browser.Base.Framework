...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _ARSavesPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _ARSavesPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "strokeprogram.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_ARSavesPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ProfessionalEduTbl { get { return this.FindElement(Bys._ARSavesPage.ProfessionalEducationTbl); } }
        public IWebElement ProfessionalEducationTblFirstLnk { get { return this.FindElement(Bys._ARSavesPage.ProfessionalEducationTblFirstLnk); } }
        public IWebElement MyRecentActivitiesTbl { get { return this.FindElement(Bys._ARSavesPage.MyRecentActivitiesTbl); } }
        public IWebElement MyRecentActivitiesTblFirstLnk { get { return this.FindElement(Bys._ARSavesPage.MyRecentActivitiesTblFirstLnk); } }
        public IWebElement FeaturedActivitiesTbl { get { return this.FindElement(Bys._ARSavesPage.FeaturedActivitiesTbl); } }
        public IWebElement FeaturedActivitiesTblFirstLnk { get { return this.FindElement(Bys._ARSavesPage.FeaturedActivitiesTblFirstLnk); } }
        public IList<IWebElement> ProfessionalEduTblHdrLnks { get { return this.FindElements(Bys._ARSavesPage.ProfessionalEducationTblHdrLnks); } }
        public IList<IWebElement> MyRecentActivitiesTblHdrLnks { get { return this.FindElements(Bys._ARSavesPage.MyRecentActivitiesTblHdrLnks); } }
        public IList<IWebElement> FeaturedActivitiesTblHdrLnks { get { return this.FindElements(Bys._ARSavesPage.FeaturedActivitiesTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_ARSavesPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._ARSavesPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _ARSavesPage", activeRequests.Count, ex); }
        }
