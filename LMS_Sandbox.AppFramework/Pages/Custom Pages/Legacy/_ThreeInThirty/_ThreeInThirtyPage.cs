...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _ThreeInThirtyPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _ThreeInThirtyPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "patienteducation.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_ThreeInThirtyPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ComingSoon1Tbl { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon1Tbl); } }
        public IWebElement ComingSoon1TblFirstLnk { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon1TblFirstLnk); } }
        public IWebElement ComingSoon2Tbl { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon2Tbl); } }
        public IWebElement ComingSoon2TblFirstLnk { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon2TblFirstLnk); } }
        public IWebElement ComingSoon3Tbl { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon3Tbl); } }
        public IWebElement ComingSoon3TblFirstLnk { get { return this.FindElement(Bys._ThreeInThirtyPage.ComingSoon3TblFirstLnk); } }
        public IList<IWebElement> ComingSoon1TblHdrLnks { get { return this.FindElements(Bys._ThreeInThirtyPage.ComingSoon1TblHdrLnks); } }
        public IList<IWebElement> ComingSoon2TblHdrLnks { get { return this.FindElements(Bys._ThreeInThirtyPage.ComingSoon2TblHdrLnks); } }
        public IList<IWebElement> ComingSoon3TblHdrLnks { get { return this.FindElements(Bys._ThreeInThirtyPage.ComingSoon3TblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_ThreeInThirtyPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._ThreeInThirtyPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _ThreeInThirtyPage", activeRequests.Count, ex); }
        }
