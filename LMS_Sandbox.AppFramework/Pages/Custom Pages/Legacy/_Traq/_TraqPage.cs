...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _TraqPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _TraqPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "spineacademy.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_TraqPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement RecordedPresentationsTbl { get { return this.FindElement(Bys._TraqPage.RecordedPresentationsTbl); } }
        public IWebElement RecordedPresentationsTblFirstLnk { get { return this.FindElement(Bys._TraqPage.RecordedPresentationsTblFirstLnk); } }
        public IWebElement RegSchedTeleconfTbl { get { return this.FindElement(Bys._TraqPage.RegSchedTeleconfTbl); } }
        public IWebElement RegSchedTeleconfTblFirstLnk { get { return this.FindElement(Bys._TraqPage.RegSchedTeleconfTblFirstLnk); } }
        public IWebElement ComingSoonTbl { get { return this.FindElement(Bys._TraqPage.ComingSoonTbl); } }
        public IWebElement ComingSoonTblFirstLnk { get { return this.FindElement(Bys._TraqPage.ComingSoonTblFirstLnk); } }
        public IList<IWebElement> ComingSoonTblHdrLnks { get { return this.FindElements(Bys._TraqPage.ComingSoonTblHdrLnks); } }
        public IList<IWebElement> RegSchedTeleconfTblHdrLnks { get { return this.FindElements(Bys._TraqPage.RegSchedTeleconfTblHdrLnks); } }
        public IList<IWebElement> RecordedPresentationsTblHdrLnks { get { return this.FindElements(Bys._TraqPage.RecordedPresentationsTblHdrLnks); } }
        ...
        /// the entire page to load. <see cref="_TraqPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._TraqPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _TraqPage", activeRequests.Count, ex); }
        }
