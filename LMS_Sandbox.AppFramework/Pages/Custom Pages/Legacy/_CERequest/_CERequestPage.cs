...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _CERequestPage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _CERequestPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "requests.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_CERequestPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        public IWebElement ClickHereLnk { get { return this.FindElement(Bys._CERequestPage.VideographyLnk); } }
        ...
        /// the entire page to load. <see cref="_CERequestPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            Browser.SwitchTo().DefaultContent();
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._CERequestPage.PageReady);
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _CERequestPage", activeRequests.Count, ex); }
        }
