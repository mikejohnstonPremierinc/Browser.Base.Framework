...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _CERequestPageCriteria
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ICriteria<_CERequestPage> VideographyLnkVisible = new Criteria<_CERequestPage>(p =>
        {
            return p.Exists(Bys._CERequestPage.VideographyLnk, ElementCriteria.IsVisible);

        }, "Videography link visible");

        public readonly ICriteria<_CERequestPage> SearchBtnVisible = new Criteria<_CERequestPage>(p =>
        {
            return p.Exists(Bys.LMSPage.SearchTxt, ElementCriteria.IsVisible);

        }, "Search button exists and is visible");

        public readonly ICriteria<_CERequestPage> Mobile_SearchMagnifyingGlassBtnVisible = new Criteria<_CERequestPage>(p =>
        {
        ...
        public readonly ICriteria<_CERequestPage> LoadIconNotExists = new Criteria<_CERequestPage>(p =>
        {
        ...
        /// page to be loaded. Note below that I am using the AND condition to combine the 3 criteria above. <see cref="_CERequestPage.WaitForInitialize"/>
        ...
        /// </summary>
        public readonly ICriteria<_CERequestPage> PageReady;

        public _CERequestPageCriteria()
        {
            PageReady = VideographyLnkVisible.AND(LoadIconNotExists);
        }
    }
}
