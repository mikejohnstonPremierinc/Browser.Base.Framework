...
namespace LMS.AppFramework
{
    ...
    /// </summary>
    public class _TeleconferencePage : LMSPage, IDisposable
    {
        #region constructors
        /// <summary>
        ...
        public _TeleconferencePage(IWebDriver driver) : base(driver)
        {
        }
        ...
        public override string PageUrl { get { return "teleconference.aspx"; } }
        ...
        /// <summary>
        /// We are retreiving these elements from the PageBy class. Specifically, <see cref="_TeleconferencesPageBys"/>. That class is where we locate all elements
        ...
        /// </summary>
        //public IWebElement FreeOnlineProfEduTbl { get { return this.FindElement(Bys._TeleconferencesPage.FreeOnlineProfEduTbl); } }
        ...
        /// the entire page to load. <see cref="_TeleconferencesPageCriteria"/> for explanations of Wait Criteria, and to see what the PageReady
        /// property (the wait criteria defined in this method) represents.
        /// </summary>
        public override void WaitForInitialize()
        {
            // The calendar element is contained in a frame within a frame, so we have to switch inside there
            ...
            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria._TeleconferencePage.PageReady);
        }
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            ...
            catch (Exception ex) { _log.ErrorFormat("Failed to dispose _TeleconferencesPage", activeRequests.Count, ex); }
        }
