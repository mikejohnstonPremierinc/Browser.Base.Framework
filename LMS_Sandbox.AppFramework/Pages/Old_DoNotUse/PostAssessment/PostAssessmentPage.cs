...
//{
//    public class PostActAssessmentPage : LMSPage, IDisposable
//    {
//        #region constructors
//        public PostActAssessmentPage(IWebDriver driver) : base(driver)
//        {
//        }
...
//        public IWebElement SubmitBtn { get { return this.FindElement(Bys.PostActAssessmentPage.SubmitBtn); } }
//        public IWebElement FirstQuestionLbl { get { return this.FindElement(Bys.PostActAssessmentPage.FirstQuestionLbl); } }
//        public IWebElement StatusPassFailLbl { get { return this.FindElement(Bys.PostActAssessmentPage.StatusPassFailLbl); } }
//        public IWebElement NumberOfAttemptsRemainingLbl { get { return this.FindElement(Bys.PostActAssessmentPage.NumberOfAttemptsRemainingLbl); } }
//        public IWebElement AttemptValueLbl { get { return this.FindElement(Bys.PostActAssessmentPage.AttemptValueLbl); } }
//        public IWebElement YourScoreValueLbl { get { return this.FindElement(Bys.PostActAssessmentPage.YourScoreValueLbl); } }
//        public IWebElement YourStatusValueLbl { get { return this.FindElement(Bys.PostActAssessmentPage.YourStatusValueLbl); } }
//        public IWebElement AssessmentNameLbl { get { return this.FindElement(Bys.PostActAssessmentPage.AssessmentNameLbl); } }
//        public IWebElement RetakeBtn { get { return this.FindElement(Bys.PostActAssessmentPage.RetakeBtn); } }
//        public IWebElement ContinueBtn { get { return this.FindElement(Bys.PostActAssessmentPage.ContinueBtn); } }
...
//        {
//            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.PostActAssessmentPage.PageReady);
...
//        {
//            if (Browser.Exists(Bys.PostActAssessmentPage.ContinueBtn))
//            {
...
//                    wait.Until(Browser =>
//                    {
//                        return Browser.Url.Contains(Constants_LMS.PageURLs.activity_evaluation.GetDescription()) 
...
//                    if (Browser.Url.Contains(Constants_LMS.PageURLs.activity_evaluation.GetDescription()))
//                    {
...
//            if (Browser.Exists(Bys.PostActAssessmentPage.SubmitBtn))
//            {
...
//                    Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(90));
//                    Browser.WaitForElement(Bys.PostActAssessmentPage.AssessmentNameLbl, TimeSpan.FromSeconds(90), ElementCriteria.IsVisible);
//                    this.WaitUntilAny(Criteria.PostActAssessmentPage.RetakeBtnVisible, Criteria.PostActAssessmentPage.ContinueBtnEnabled,
//                        Criteria.PostActAssessmentPage.YourStatusValueLblTextEqualsSubmitted);
//                    return null;
//                }
//            }

//            if (Browser.Exists(Bys.PostActAssessmentPage.RetakeBtn))
//            {
...
//                    Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(90));
//                    Browser.WaitForElement(Bys.PostActAssessmentPage.AssessmentNameLbl, TimeSpan.FromSeconds(90), ElementCriteria.IsVisible);
//                    this.WaitUntilAny(Criteria.PostActAssessmentPage.LoadIconNotExists, Criteria.PostActAssessmentPage.SubmitBtnVisible);
//                    return null;
//                }
//            }
...
//            catch (Exception ex) { _log.ErrorFormat("Failed to dispose PosstActAssessmentPage", activeRequests.Count, ex); }
//        }
