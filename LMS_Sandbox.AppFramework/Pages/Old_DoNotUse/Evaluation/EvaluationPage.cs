...
//{
//    public class EvaluationPage : LMSPage, IDisposable
//    {
//        #region constructors
//        public EvaluationPage(IWebDriver driver) : base(driver)
//        {
//        }
...
//        public IWebElement SubmitBtn { get { return this.FindElement(Bys.EvaluationPage.SubmitBtn); } }
//        public IWebElement FirstQuestionLbl { get { return this.FindElement(Bys.EvaluationPage.FirstQuestionLbl); } }
//        public IWebElement StatusPassFailLbl { get { return this.FindElement(Bys.EvaluationPage.StatusPassFailLbl); } }
//        public IWebElement NumberOfAttemptsRemainingLbl { get { return this.FindElement(Bys.EvaluationPage.NumberOfAttemptsRemainingLbl); } }
//        public IWebElement AttemptValueLbl { get { return this.FindElement(Bys.EvaluationPage.AttemptValueLbl); } }
//        public IWebElement YourScoreValueLbl { get { return this.FindElement(Bys.EvaluationPage.YourScoreValueLbl); } }
//        public IWebElement YourStatusValueLbl { get { return this.FindElement(Bys.EvaluationPage.YourStatusValueLbl); } }
//        public IWebElement AssessmentNameLbl { get { return this.FindElement(Bys.EvaluationPage.AssessmentNameLbl); } }
//        public IWebElement RetakeBtn { get { return this.FindElement(Bys.EvaluationPage.RetakeBtn); } }
//        public IWebElement ContinueBtn { get { return this.FindElement(Bys.EvaluationPage.ContinueBtn); } }
...
//        {
//            this.WaitUntil(TimeSpan.FromSeconds(90), Criteria.EvaluationPage.PageReady);
...
//        {
//            if (Browser.Exists(Bys.EvaluationPage.ContinueBtn))
//            {
...
//            if (Browser.Exists(Bys.EvaluationPage.SubmitBtn))
//            {
...
//                    Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(90));
//                    Browser.WaitForElement(Bys.EvaluationPage.AssessmentNameLbl, TimeSpan.FromSeconds(90), ElementCriteria.IsVisible);
//                    this.WaitUntilAny(Criteria.EvaluationPage.RetakeBtnVisible, Criteria.EvaluationPage.ContinueBtnEnabled,
//                        Criteria.EvaluationPage.YourStatusValueLblTextEqualsSubmitted);
//                    return null;
//                }
//            }

//            if (Browser.Exists(Bys.EvaluationPage.RetakeBtn))
//            {
...
//                    Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(90));
//                    Browser.WaitForElement(Bys.EvaluationPage.AssessmentNameLbl, TimeSpan.FromSeconds(90), ElementCriteria.IsVisible);
//                    this.WaitUntilAny(Criteria.EvaluationPage.LoadIconNotExists, Criteria.EvaluationPage.SubmitBtnVisible);
//                    return null;
//                }
//            }
...
//                AssessmentNameLbl.Text, isAnswerCorrect: false, returnDistinctQuestions: true);
