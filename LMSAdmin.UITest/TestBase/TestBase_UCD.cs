...
namespace LMSAdmin.AppFramework
{
    ...
    /// </summary>
    public abstract class TestBase_UCD : TestBase
    {        
        //Users        
        ...
        // Sites
        //public const Constants.SiteCodes siteCodeAttribute = Constants.SiteCodes.UCD;
        public const string siteCodeCategory = "UCD";
        public const string password = "password";
        public const string siteName = "University of California, Davis";

        #region Constructors
        // Local Selenium Test
        public TestBase_UCD(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public TestBase_UCD(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public override void BeforeTest()
        {
            ...
            {
                 Autotest_user1 = UserUtils.UCD_TestUser1_Ch;               
            ...
            {
                 Autotest_user1 = UserUtils.UCD_TestUser2_FF;                
            ...
            if (BrowserName == BrowserNames.Chrome)
            {                
                Autotest_user2 = UserUtils.UCD_TestUser3_Ch;
                Autotest_Activity1 = UserUtils.Activity_Chrome;
                Autotest_ActivityNegativeCase = UserUtils.ActivityNegativeCase_Chrome;
                Autotest_LiveActivity1 = UserUtils.LiveActivity_Chrome;
            }
            ...
            {             
                Autotest_user2 = UserUtils.UCD_TestUser4_FF;
                Autotest_Activity1 = UserUtils.Activity_Firefox;
                Autotest_ActivityNegativeCase = UserUtils.ActivityNegativeCase_Firefox;
                Autotest_LiveActivity1 = UserUtils.LiveActivity_Firefox;
            }
