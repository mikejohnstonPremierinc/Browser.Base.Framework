...
namespace LMSAdmin.AppFramework
{
    ...
    public abstract class TestBase : BrowserTest
    {
        ...
        public const string CommonAccreditationbody = "CME California";

        // production environment testing password for all organisations admin login's 
        ...
        {
            base.AfterTest();
            Navigation.GoToSignOutPage(Browser);
            browser.Navigate().GoToUrl(AppSettings.Config["PremierSignOutURL"]);
        }
    }
}