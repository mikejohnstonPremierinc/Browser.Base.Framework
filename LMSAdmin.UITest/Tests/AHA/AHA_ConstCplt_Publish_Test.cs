...
namespace LMSAdmin_AHA.UITest
{
   ...
   [TestFixture]
    public class AHA_ConstCplt_Publish_Test : TestBase_AHA
    {
        #region Constructors
        public AHA_ConstCplt_Publish_Test(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public AHA_ConstCplt_Publish_Test(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void AccreditationandCompletionPathway_NegativeCases()
        {
            ...
            MyDashboardPage MDP = LP.Login(Constants_LMSAdmin.LoginUserNames.AHA, "password");
            ...
            Assert.False(Browser.Exists(Bys.ActAccreditationPage.ClaimCreditEnabledChkbox, ElementCriteria.IsVisible),
                "ClaimCreditEnabled Checkbox should not be visible in UI for AHA ");
