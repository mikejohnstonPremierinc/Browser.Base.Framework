...
namespace LMSAdmin_AHA.UITest
{
    ...
    [TestFixture]
    public class AHA_CompletionPathwayTest : TestBase_AHA
    {
        #region Constructors
        public AHA_CompletionPathwayTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public AHA_CompletionPathwayTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
