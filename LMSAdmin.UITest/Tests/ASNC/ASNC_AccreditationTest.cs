...
namespace LMSAdmin_ASNC.UITest
{
   ...
   [TestFixture]
    public class ASNC_AccreditationTest : TestBase_ASNC
    {
        #region Constructors
        public ASNC_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public ASNC_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
