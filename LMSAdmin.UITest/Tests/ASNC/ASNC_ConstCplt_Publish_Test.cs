...
namespace LMSAdmin_ASNC.UITest
{
    //[NonParallelizable]
   ...
   [TestFixture]
    public class ASNC_ConstCplt_Publish_Test : TestBase_ASNC
    {
        #region Constructors
        public ASNC_ConstCplt_Publish_Test(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public ASNC_ConstCplt_Publish_Test(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void AccreditationandCompletionPathway_NegativeCases()
        {
            ...
            MyDashboardPage MDP = LP.Login(Constants_LMSAdmin.LoginUserNames.ASNC, "password");
            ...
            Assert.False(Browser.Exists(Bys.ActAccreditationPage.ClaimCreditEnabledChkbox, ElementCriteria.IsVisible),
                "ClaimCreditEnabled Checkbox should not be visible in UI for ASNC ");
