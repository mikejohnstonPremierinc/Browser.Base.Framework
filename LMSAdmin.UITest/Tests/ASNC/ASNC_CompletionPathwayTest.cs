...
namespace LMSAdmin_ASNC.UITest
{
    ...
    [TestFixture]
    public class ASNC_CompletionPathwayTest : TestBase_ASNC
    {
        #region Constructors
        public ASNC_CompletionPathwayTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public ASNC_CompletionPathwayTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
