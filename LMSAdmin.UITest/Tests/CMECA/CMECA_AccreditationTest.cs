...
namespace LMSAdmin_CMECA.UITest
{
   ...
   [TestFixture]
    public class CMECA_AccreditationTest : TestBase_CMECA
    {
        #region Constructors
        public CMECA_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public CMECA_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
 ...
 //Select "Landscape" type , choose the newly created scenario and save the award
    ...
    //    [Test]
        ...
        public void AccreditationManagement_LiveActivityWithSessionCases()
        {
            ...
            /////// below step is commented due to this defect  https://code.premierinc.com/issues/browse/LMSPLT-4321  
