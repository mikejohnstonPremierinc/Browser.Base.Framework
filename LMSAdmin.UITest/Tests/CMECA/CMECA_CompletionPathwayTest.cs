...
namespace LMSAdmin_CMECA.UITest
{
    ...
    [TestFixture]
    public class CMECA_CompletionPathwayTest : TestBase_CMECA
    {
        #region Constructors
        public CMECA_CompletionPathwayTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public CMECA_CompletionPathwayTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void CompletionPathwayManagement_ScenarioSettings()
        {
            ...
            Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(100));Thread.Sleep(TimeSpan.FromSeconds(60));
            ...
            ACPLP.confirmMsgPopupOkBtn.Click(Browser); Thread.Sleep(TimeSpan.FromSeconds(60));
            Browser.Exists(Bys.Page.AlertNotificationIconMsg, ElementCriteria.TextContains("success"));          
            Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(100));
        ...
        public void CompletionPathwayManagement_DeliverySettings()
        {
            ...
            ACPLP.confirmMsgPopupOkBtn.Click(Browser);
            Browser.Exists(Bys.Page.AlertNotificationIconMsg, ElementCriteria.TextContains("success"));
            ACPLP.WaitUntil(TimeSpan.FromSeconds(180),Criteria.ActCompletionPathwayPage.LoadIconNotExists);
            Browser.WaitJSAndJQuery(TimeSpan.FromSeconds(3));
