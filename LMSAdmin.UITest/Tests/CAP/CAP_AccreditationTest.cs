...
namespace LMSAdmin_CAP.UITest
{
   ...
   [TestFixture]
    public class CAP_AccreditationTest : TestBase_CAP
    {
        #region Constructors
        public CAP_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public CAP_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
