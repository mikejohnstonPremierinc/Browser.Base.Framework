...
namespace LMSAdmin_CAP.UITest
{
   ...
   [TestFixture]
    public class CAP_ConstCplt_Publish_Test : TestBase_CAP
    {
        #region Constructors
        public CAP_ConstCplt_Publish_Test(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public CAP_ConstCplt_Publish_Test(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void AccreditationandCompletionPathway_NegativeCases()
        {
            ...
            MyDashboardPage MDP = LP.Login(Constants_LMSAdmin.LoginUserNames.CAP, "password");
            ...
            Assert.False(Browser.Exists(Bys.ActAccreditationPage.ClaimCreditEnabledChkbox, ElementCriteria.IsVisible),
                "ClaimCreditEnabled Checkbox should not be visible in UI for CAP ");
