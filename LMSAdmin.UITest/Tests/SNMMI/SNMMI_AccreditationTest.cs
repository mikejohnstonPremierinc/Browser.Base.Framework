...
namespace LMSAdmin_SNMMI.UITest
{
   ...
   [TestFixture]
    public class SNMMI_AccreditationTest : TestBase_SNMMI
    {
        #region Constructors
        public SNMMI_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public SNMMI_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
