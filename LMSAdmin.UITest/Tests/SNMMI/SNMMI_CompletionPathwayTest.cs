...
namespace LMSAdmin_SNMMI.UITest
{
    ...
    [TestFixture]
    public class SNMMI_CompletionPathwayTest : TestBase_SNMMI
    {
        #region Constructors
        public SNMMI_CompletionPathwayTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public SNMMI_CompletionPathwayTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
