...
namespace LMSAdmin_SNMMI.UITest
{
    //[NonParallelizable]
   ...
   [TestFixture]
    public class SNMMI_ConstCplt_Publish_Test : TestBase_SNMMI
    {
        #region Constructors
        public SNMMI_ConstCplt_Publish_Test(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public SNMMI_ConstCplt_Publish_Test(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void AccreditationandCompletionPathway_NegativeCases()
        {
            ...
            MyDashboardPage MDP = LP.Login(Constants_LMSAdmin.LoginUserNames.SNMMI, "password");
            ...
            Assert.False(Browser.Exists(Bys.ActAccreditationPage.ClaimCreditEnabledChkbox, ElementCriteria.IsVisible),
                "ClaimCreditEnabled Checkbox should not be visible in UI for SNMMI ");
