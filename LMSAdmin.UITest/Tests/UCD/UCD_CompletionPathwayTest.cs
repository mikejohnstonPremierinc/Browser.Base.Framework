...
namespace LMSAdmin_UCD.UITest
{
    ...
    [TestFixture]
    public class UCD_CompletionPathwayTest : TestBase_UCD
    {
        #region Constructors
        public UCD_CompletionPathwayTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public UCD_CompletionPathwayTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
