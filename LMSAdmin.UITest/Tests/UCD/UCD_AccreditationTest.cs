...
namespace LMSAdmin_UCD.UITest
{
   ...
   [TestFixture]
    public class UCD_AccreditationTest : TestBase_UCD
    {
        #region Constructors
        public UCD_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public UCD_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
