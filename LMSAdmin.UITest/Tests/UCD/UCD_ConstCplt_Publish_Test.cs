...
namespace LMSAdmin_UCD.UITest
{
   ...
   [TestFixture]
    public class UCD_ConstCplt_Publish_Test : TestBase_UCD
    {
        #region Constructors
        public UCD_ConstCplt_Publish_Test(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public UCD_ConstCplt_Publish_Test(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
        ...
        public void AccreditationandCompletionPathway_NegativeCases()
        {
            ...
            Assert.False(Browser.Exists(Bys.ActAccreditationPage.ClaimCreditEnabledChkbox, ElementCriteria.IsVisible),
                "ClaimCreditEnabled Checkbox should not be visible in UI for UCD ");
