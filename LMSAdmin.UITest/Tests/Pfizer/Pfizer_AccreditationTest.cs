...
namespace LMSAdmin_Pfizer.UITest
{
   ...
   [TestFixture]
    public class Pfizer_AccreditationTest : TestBase_Pfizer
    {
        #region Constructors
        public Pfizer_AccreditationTest(string browserName, string emulationDevice) : base(browserName, emulationDevice) { }

        // Remote Selenium Grid Test
        public Pfizer_AccreditationTest(string browserName, string emulationDevice, string version, string platform, string hubUri, string extrasUri)
 ...
 //Select "Landscape" type , choose the newly created scenario and save the award
        ...
        public void AccreditationManagement_EditAccreditation()
        {
            ...
            string primaryProvider_AfterEdit = CommonAccreditationbody;
