...
{
    public class CACCPDActivitiesList : MainproPage, IDisposable
    {
        #region constructors
        public CACCPDActivitiesList(IWebDriver driver) : base(driver)
        {
        }
        ...
        #region elements
        public IWebElement CreditsToApplyTopLnk { get { return this.FindElement(Bys.CACCPDActivitiesListPage.CreditsToApplyTopLnk); } }
        public IWebElement CreditsToApplySecondLnk { get { return this.FindElement(Bys.CACCPDActivitiesListPage.CreditsToApplySecondLnk); } }
        public IWebElement CreditsToApplyThirdLnk { get { return this.FindElement(Bys.CACCPDActivitiesListPage.CreditsToApplyThirdLnk); } }

        public IWebElement FirstCACAllocationTxt { get { return this.FindElement(Bys.CACCPDActivitiesListPage.FirstCACAllocationTxt); } }
        public IWebElement PopupSubmitBtn { get { return this.FindElement(Bys.CACCPDActivitiesListPage.PopupSubmitBtn); } }
        #endregion elements
        ...
        //this function will clear the text box on the page
        public void ClearTextBox(IWebElement firstCACAllocationTxt)
        {
            for (int x = 0; x < 10; x++) {
                ElemSet.SendKeysAfterScroll(Browser, FirstCACAllocationTxt, Keys.Right);
            }
            for (int x = 0; x < 10; x++)
            {
                ElemSet.SendKeysAfterScroll(Browser, FirstCACAllocationTxt, Keys.Backspace);
            }
        }
